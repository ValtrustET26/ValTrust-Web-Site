...
// Progress tracker — how many required fields are filled
...
function SectionCard({ icon, title, children, step }: {
    ...
    return (
        <div className="flex flex-col bg-[#0B1E4A] w-130 rounded-2xl overflow-hidden">
            {/* Section header */}
            <div className="flex items-center gap-x-3 px-6 pt-5 pb-4 border-b border-white/10">
...
// Toggle chip for checkboxes — nicer than raw checkboxes
...
export default function Valuation() {
    ...
    return (
        <section className="flex flex-col items-center bg-gray-50 py-12 px-4 min-h-screen">
            <div className="flex flex-col items-center w-full max-w-lg gap-y-8">
                ...
                <div className="flex flex-col items-center text-center gap-y-4 w-full">
                    ...
                    <h1 className="text-4xl font-semibold text-[#0D4687] tracking-tight leading-tight">
                        Ready to discover your<br />property value?
                    </h1>
                    <p className="text-base text-[#0B1E4A]/70 max-w-sm">
                ...
                <SectionCard icon="/Valuation/bed-icon.png" title="Rooms & Spaces" step={3}>
                    <div className="flex flex-col gap-y-5">
                        {/* Stepper counters for bedrooms / bathrooms / parking */}
                        {[
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-y-3 mt-1">
                                {[
                            ...
                            <div className="flex flex-col gap-y-2 mt-1">
                                {[
                                    ...
                                    <label key={value} className="flex items-center justify-between cursor-pointer group">
                                        <div className="flex items-center gap-x-3">
                                            <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors ${form.condition === value ? "border-emerald-400 bg-emerald-400" : "border-white/30"
                                                }`}>
                ...
                {/* ── SUBMIT ── */}
                <div className="w-130 bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col gap-y-4">
