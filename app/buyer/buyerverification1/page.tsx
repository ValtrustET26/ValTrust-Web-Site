...
return ( <main className="min-h-screen bg-[#f5f5f5] flex items-center justify-center px-4 py-10"> <section className="w-full max-w-6xl bg-white rounded-3xl shadow-xl border border-gray-200 p-8 md:p-12">
...
```
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="text-center mt-14">
        <p className="text-[#172554] font-semibold text-xl leading-snug">
          Upload your ID and verify your face.
        </p>
    ...
    {/* STEPS */}
    <div className="flex flex-col md:flex-row justify-center items-start gap-8 mt-16">
      {steps.map((item) => {
